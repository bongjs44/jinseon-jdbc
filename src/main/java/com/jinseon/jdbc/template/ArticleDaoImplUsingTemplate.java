package com.jinseon.jdbc.template;
...
import com.jinseon.jdbc.raw.Article;
import com.jinseon.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/bongdb?user=bong&password=7966");
